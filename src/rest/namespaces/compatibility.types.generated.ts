...
export interface CompatibilityErrorArrayItem {
...
export interface CompatibilityErrorArrayResponse {
  /** A list of errors */
  errors?: CompatibilityErrorArrayItem[];
}
...
export interface CompatibilityErrorStringArrayResponse {
  /** List of validation error messages. */
  errors: string[];
}

/** Error response model with string code for ImportedPhoneNumbers. */
export interface CompatibilityImportedPhoneNumberError {
  /** The error code. */
  code?: string;
...
export interface CompatibilityTokenValidationError {
  /** Error type. */
  type?: string;
  /** Error code. */
  code?: string;
...
export type CreateSubprojectsRequest = CreateSubprojectRequest;

export type CreateSubprojectsResponse = Account;

export type ListApplicationsResponse = ApplicationListResponse;

export type CreateApplicationResponse = Application;

export type GetApplicationResponse = ApplicationResponse;

export type UpdateApplicationResponse = ApplicationResponse;

export type ListAvailablePhoneNumberResourcesResponse = AvailablePhoneNumberResourcesResponse;

export type ListAvailablePhoneNumberResourcesByCountryResponse =
  AvailablePhoneNumberByCountryResponse;

export type SearchLocalAvailablePhoneNumbersResponse = AvailablePhoneNumberListResponse;

export type SearchTollFreeAvailablePhoneNumbersResponse = AvailablePhoneNumberListResponse;

export type ListAllCallsResponse = CallListResponse;

export type CreateACallRequest = CreateCallRequest;

export type CreateACallResponse = CallResponse;

export type CreateRecordingRequest = CreateCallRecordingRequest;

export type CreateRecordingResponse = CallRecordingResponse;

export type UpdateRecordingRequest = UpdateCallRecordingRequest;

export type UpdateRecordingResponse = CallRecordingResponse;

export type CreateStreamRequest = CreateCallStreamRequest;

export type CreateStreamResponse = CallStreamResponse;

export type UpdateStreamRequest = UpdateCallStreamRequest;

export type UpdateStreamResponse = CallStreamResponse;

export type RetrieveACallResponse = CallResponse;

export type UpdateACallRequest = UpdateCallRequest;

export type UpdateACallResponse = CallResponse;

export type ListAllConferencesResponse = ConferenceListResponse;

export type ListAllParticipantsResponse = ConferenceParticipantListResponse;

export type RetrieveParticipantResponse = ConferenceParticipantResponse;

export type UpdateParticipantRequest = UpdateConferenceParticipantRequest;

export type UpdateParticipantResponse = ConferenceParticipantResponse;

export type ListConferenceRecordingsResponse = ConferenceRecordingListResponse;

export type GetConferenceRecordingResponse = ConferenceRecordingResponse;

export type UpdateConferenceRecordingResponse = ConferenceRecordingResponse;

export type CreateConferenceStreamResponse = ConferenceStreamResponse;

export type UpdateConferenceStreamResponse = ConferenceStreamResponse;

export type RetrieveConferenceResponse = ConferenceResponse;

export type UpdateConferenceResponse = ConferenceResponse;

export type ListAllFaxesResponse = FaxListResponse;

export type SendFaxResponse = FaxResponse;

export type ListAllFaxMediaResponse = FaxMediaListResponse;

export type RetrieveMediasResponse = FaxMediaResponse;

export type RetrieveFaxResponse = FaxResponse;

export type UpdateFaxResponse = FaxResponse;

export type CreateImportedPhoneNumberRequest = ImportPhoneNumberRequest;

export type CreateImportedPhoneNumberResponse = IncomingPhoneNumber;

export type ListIncomingPhoneNumbersResponse = IncomingPhoneNumberListResponse;

export type CreateIncomingPhoneNumberResponse = IncomingPhoneNumber;

export type RetrieveIncomingPhoneNumberResponse = IncomingPhoneNumberResponse;

export type UpdateIncomingPhoneNumberResponse = IncomingPhoneNumberResponse;

export type ListCxmlScriptsResponse = CxmlScriptListResponse;

export type CreateCxmlScriptResponse = CxmlScript;

export type RetrieveCxmlScriptResponse = CxmlScriptResponse;

export type UpdateCxmlScriptResponse = CxmlScriptResponse;

export type ListMessagesResponse = MessageListResponse;

export type CreateMessageResponse = Message;

export type ListMediaResponse = MessageMediaListResponse;

export type RetrieveMediaResponse = MessageMediaResponse;

export type RetrieveMessageResponse = MessageResponse;

export type UpdateMessageResponse = MessageResponse;

export type ListQueuesResponse = QueueListResponse;

export type CreateQueueResponse = Queue;

export type ListAllQueueMembersResponse = QueueMemberListResponse;

export type RetrieveQueueMemberResponse = QueueMemberResponse;

export type UpdateQueueMemberResponse = QueueMemberResponse;

export type RetrieveQueueResponse = QueueResponse;

export type UpdateQueueResponse = QueueResponse;

export type ListRecordingsResponse = RecordingListResponse;

export type RetrieveRecordingResponse = RecordingResponse;

export type ListTranscriptionsResponse = TranscriptionListResponse;

export type RetrieveTranscriptionResponse = TranscriptionResponse;
